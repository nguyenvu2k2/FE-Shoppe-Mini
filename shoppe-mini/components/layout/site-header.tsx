...
export default function SiteHeader() {
    ...
    return (
        <header className="sticky top-0 z-50 shadow-md shadow-orange-900/10">
            <div className="bg-gradient-to-r from-[#c73e1d] via-[#ee4d2d] to-[#ff6b4a] px-4 py-1.5 text-center text-xs text-white/90">
                Miễn phí vận chuyển cho đơn từ 199K · Giao nhanh 2H nội thành
            </div>
                ...
                <div className="mx-auto flex max-w-[1200px] items-center gap-4 px-4 py-3 sm:gap-6">
                    ...
                    <nav className="ml-auto flex items-center gap-2 sm:gap-3">
                        ...
                        >
                            ...
                            <span className="absolute -top-1 -right-1 flex size-4 items-center justify-center rounded-full bg-[#ee4d2d] text-[10px] font-bold text-white">
                                0
                            </span>
                        </Link>
                        ...
                        <div className="group relative">
                            <button
                                ...
                                aria-haspopup="true"
                            >
                                <img src={user?.avatar ?? initialsFromName(user?.fullName ?? "?")} alt="Avatar" className="flex size-8 items-center justify-center rounded-lg bg-gradient-to-br from-[#ee4d2d] to-[#ff8c5a] text-xs font-semibold text-white" />
